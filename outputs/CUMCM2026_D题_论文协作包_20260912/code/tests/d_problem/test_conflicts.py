...
class ConflictTests(unittest.TestCase):
    ...
    def test_c083_expands_to_final_boundary(self) -> None:
        ...
        plans = load_plans(package_root / "data/附件1.xlsx")
    ...
    def test_full_attachment_matches_independent_grid_crosscheck(self) -> None:
        ...
        frame = pd.read_excel(root / "data/附件1.xlsx", dtype={"用频装备编号": str})
        ...
        interval_pairs = {
            ...
            for pair in find_conflict_pairs(
                [PlanState(plan) for plan in load_plans(root / "data/附件1.xlsx")]
            )
        }
