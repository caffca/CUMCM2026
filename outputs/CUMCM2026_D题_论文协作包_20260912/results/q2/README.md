...
问题级模型、路线比较和论文措辞见 [`source_docs/Q2_report.md`](../../source_docs/Q2_report.md)；模型质量、少量设备验证边界和 R² 说明见 [`source_docs/Q2_quality.md`](../../source_docs/Q2_quality.md)。本地与队友分支的目标协议和证据接入规则见 [`source_docs/branch_audit.md`](../../source_docs/branch_audit.md)。
...
所有 `selected_*.json` 与对应 `result2_*.xlsx` 均由同一候选状态索引生成，并经过 `validate_schedule()`；详细推导和时间线见 `source_docs/modeling_process.md` §6.2.6。
